...
<html>
<head>
    <title>One Year Result Review PDF</title>
    <style>
        @font-face {
    ...
    <div class="container custom-font">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <tr>
                        <td style="width: 180px">
                            ...
                            <table style="margin-top: 15px; font-size: 10px; border: 1px solid black; margin-left: 0; padding-left: 0; border-collapse: collapse; width: 250px;">
                                ...
                                <tr style="border: none;">
                                    ...
                                    <th style="vertical-align: top;">: </th>
                                    <th style="text-align: left"><?= $approval['department']; ?></th>
                                </tr>
                                <tr style="border: none;">
                                    <th style="text-align: left; vertical-align: top;">Division</th>
                                    <th style="vertical-align: top;">: </th>
                                    <th style="text-align: left"><?= $approval['division']; ?></th>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <div style="text-align: center;">
                                ...
                                <h3 style="margin:auto;"><i>One Year Result Review</i></h3>
                            </div>
                        </td>
                        <td>
                            ...
                            <table class="info-table" style="border-collapse: collapse; font-size: 9px; margin: 5px auto;">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left;">
                                        <?php 
                                            if($approval['kode_jabatan'] == 8 && (!in_array($approval['created_by'], [3659, 3651]))){echo date("d F Y", strtotime($approval['approval_date_kadept_oneyear']));}
                                            elseif($approval['kode_jabatan'] == 4 || ($approval['kode_jabatan'] == 8 && !in_array($approval['created_by'], [3651, 3659]))) {echo date("d F Y", strtotime($approval['approval_date_kadiv_oneyear']));}
                                            elseif($approval['kode_jabatan'] == 3) {echo date("d F Y", strtotime($approval['approval_date_bod_oneyear']));}
                                            elseif($approval['kode_jabatan'] == 2) {echo date("d F Y", strtotime($approval['approval_date_presdir_oneyear']));}
                                        ?>
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    <th style="text-align: left;">
                                        <?php 
                                            if ($approval['kode_jabatan'] == 8 && $approval['created_by'] != [3659, 3651]){
                                                echo ucword(strtolower($approval['approved_kasie_by_one']));
                                            } elseif ($approval['kode_jabatan'] == 4 || ($approval['kode_jabatan'] == 8 && $approval['created_by'] == [3659, 3651])){
                                                echo ucwords(strtolower($approval['approved_kadept_by_one']));
                                            } elseif ($approval['kode_jabatan'] == 3){
                                                echo ucwords(strtolower($approval['approved_kadiv_by_one']));
                                            } elseif ($approval['kode_jabatan'] == 2){
                                                echo ucwords(strtolower($approval['approved_bod_by_one']));
                                            } 
                                        ?>
                                    </th>
                                </tr>
                ...
                <table id="isidetail" style="width: 100%; font-size: 12px; border: 1px solid black; border-collapse: collapse; margin-top: 32px;">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style="border-bottom: hidden; text-align: center; vertical-align: middle; border: 1px solid black; border-collapse: collapse; width: 130px;">One Year Target</th>
                            <th rowspan="2" style="border-bottom: 1px solid #dee2e6; text-align: center; vertical-align: middle; border: 1px solid black; border-collapse: collapse; width: 130px;">One Year Achievement</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border-collapse: collapse; border-right: 1px solid black; text-align: center; vertical-align: top; position: relative; top: 0;" data-id="<?= $d['id']; ?>"><?= $d['oneyear']; ?></td>
                            <td style="border-collapse: collapse; border-right: 1px solid black; text-align: center; vertical-align: top; position: relative; top: 0;" data-id="<?= $d['id']; ?>"><?= $d['oneyear_achv']; ?></td>
                            <td style="text-align: center; border-collapse: collapse; border-right: 1px solid black; vertical-align: top; position: relative; top: 0;" data-id="<?= $d['id']; ?>"><?= $d['oneyear_achv_score']; ?></td>
                            <td style="text-align: center; border-collapse: collapse; border-right: 1px solid black; vertical-align: top; position: relative; top: 0;" data-id="<?= $d['id']; ?>"><?= $d['oneyear_achv_total']; ?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php 
                            $totalWeight = 0;
                            ...
                            foreach($oneyear as $d){
                                ...
                                $score = floatval($d['oneyear_achv_total']);
                                if (!is_nan($weight)) {
                                    $totalWeight += $weight;
                                }
                                if (!is_nan($score)){
                    ...
                    <tr>
                            ...
                            <?php
                                if ($approval['kode_jabatan'] == 8 && $approval['created_by'] != [960, 4277, 3659, 1814, 2070, 2322, 2364, 2592]) { 
                                    ...
                                    if ($approval['approval_bod_oneyear'] == 1 && $approval['approval_presdir_oneyear'] == 1){
                                        echo (ucwords(strtolower($approval['approved_presdir_by_one'])));
                                    }
                                }
                            ?>
                        </td>
                        <td class="table-colapse" style="width: 170px; text-align: left;">
                            ...
                            <?php
                                if ($approval['kode_jabatan'] == 8 && $approval['created_by'] != [960, 4277, 3659, 1814, 2070, 2322, 2364, 2592]) { 
                                    if ($approval['approval_kasie_oneyear'] == 1 && $approval['approval_kadept_oneyear'] == 1){
                                        echo ucwords(strtolower(ucwords(strtolower($approval['approved_kasie_by_one']))));
                                    }
                                } elseif ($approval['kode_jabatan'] == 4 || ($approval['kode_jabatan'] == 8 && $approval['created_by'] == [960, 4277, 3659, 1814, 2070, 2322, 2364, 2592])){ 
                                    if ($approval['approval_kadept_oneyear'] == 1 && $approval['approval_kadiv_oneyear'] == 1){
                                        echo ucwords(strtolower(ucwords(strtolower($approval['approved_kadept_by_one']))));
                                    }
                                } elseif ($approval['kode_jabatan'] == 3){ 
                                    if ($approval['approval_kadiv_oneyear'] == 1 && $approval['approval_bod_oneyear'] == 1){
                                        echo ucwords(strtolower(ucwords(strtolower($approval['approved_kadiv_by_one']))));
                                    }
                                } elseif ($approval['kode_jabatan'] == 2){ 
                                    if ($approval['approval_bod_oneyear'] == 1 && $approval['approval_presdir_oneyear'] == 1){
                                        echo ucwords(strtolower(ucwords(strtolower($approval['approved_bod_by_one']))));
                                    }
                                }
                            ?>
                        </td>
                            ...
                            if ($approval['kode_jabatan'] == 8 && $approval['created_by'] != [960, 4277, 3659, 1814, 2070, 2322, 2364, 2592]) { 
                                ...
                                echo '
                                    <td class="table-colapse" style="height: 50px; text-align: center; border-bottom: 0px;">
                                        <span style="text-align: center">Approved By</span><br>'. ucwords(strtolower($approval['approved_kadept_by_one'])) .'                               
                                    </td>
                                    <td class="table-colapse" style="height: 50px; text-align: center; border-bottom: 0px;">
                                        <span style="text-align: center">Approved By</span><br>'. ucwords(strtolower($approval['approved_kasie_by_one'])) .'                               
                                    </td>
                                ...
                                echo '
                                    <td class="table-colapse" style="height: 50px; text-align: center; border-bottom: 0px;">
                                        <span style="text-align: center">Approved By</span><br>' . ucwords(strtolower($approval['approved_kadiv_by_one'])) . '
                                    </td>
                                    <td class="table-colapse" style="height: 50px; text-align: center; border-bottom: 0px;">
                                        <span style="text-align: center">Approved By</span><br>'. ucwords(strtolower($approval['approved_kadept_by_one'])) .'
                                    </td>
                                ...
                                echo '
                                    <td class="table-colapse" style="height: 50px; text-align: center; border-bottom: 0px;; position: relative;">
                                        <span style="text-align: center">Approved By</span><br>'. ucwords(strtolower($approval['approved_bod_by_one'])) .'                               
                                    </td>
                                    <td class="table-colapse" style="height: 50px; text-align: center; border-bottom: 0px;; position: relative;"> 
                                        <span style="text-align: center">Approved By</span><br>' . ucwords(strtolower($approval['approved_kadiv_by_one'])) . '                               
                                    </td>
                                ...
                                echo '
                                    <td class="table-colapse" style="height: 50px; text-align: center; border-bottom: 0px;">
                                        <span style="text-align: center">Approved By</span><br>'. ucwords(strtolower($approval['approved_presdir_by_one'])) .'</span>
                    ...
                    <tr>
                        <?php
                            if ($approval['kode_jabatan'] == 8 && $approval['created_by'] != [960, 4277, 3659, 1814, 2070, 2322, 2364, 2592]) { 
                                ...
                                echo date("d F Y", strtotime($approval['date_submitted_one']));
                                echo '</td>';} 
                            } elseif ($approval['kode_jabatan'] == 4 || ($approval['kode_jabatan'] == 8 && $approval['created_by'] == [960, 4277, 3659, 1814, 2070, 2322, 2364, 2592])){ 
                                if ($approval['approval_kadept_oneyear'] == 1 && $approval['approval_kadiv_oneyear'] == 1){
                                echo '
