        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6"> <!-- Kolom kiri, ukuran setengah lebar dari total lebar grid -->
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table" id="peopleMng">
                                        <thead>
                                            <tr>
                                                <th rowspan="2">Aspect</th>
                                                <th rowspan="1" style="border-top: hidden">Achievement (Mid Year)</th>
                                            </tr>
                                            <tr style="border-top: hidden">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="<?= base_url('daftarprocsum/index') ?>" class="btn btn-primary btn-sm mr-2" style="width: 100px; height: 30px;">Kembali</a>
                        <?php
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-md-12 mt-3">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Mid Year Review</h5>
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <th>A. Result</th>
    ...
    $(document).ready(function () {
        ...
        $('.plan_mid').on('input', function () {
                ...
                if (plan_mid < 1 || plan_mid > 5) {
                    ...
                    $(this).siblings('.invalid-feedback').text('Plan (Mid Year) must be between 1 and 5.');
                    // console.log('Pesan validasi Plan (Mid Year) terpanggil');
                } else {
            ...
            $('.do_mid').on('input', function () {
                ...
                if (do_mid < 1 || do_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Do (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
            ...
            $('.check_mid').on('input', function () {
                ...
                if (check_mid < 1 || check_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Check (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
            ...
            $('.act_mid').on('input', function () {
                ...
                if (act_mid < 1 || act_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Action (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
            ...
            $('.teamwork_mid').on('input', function () {
                ...
                if (teamwork_mid < 1 || teamwork_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Teamwork (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
            ...
            $('.cust_mid').on('input', function () {
                ...
                if (cust_mid < 1 || cust_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Customer Focus (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
            ...
            $('.passion_mid').on('input', function () {
                ...
                if (passion_mid < 1 || passion_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Passion for Excellence (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
            ...
            $('.gc_mid').on('input', function () {
                ...
                if (gc_mid < 1 || gc_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Getting Commitment on IPP (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
            ...
            $('.delegating_mid').on('input', function () {
                ...
                if (delegating_mid < 1 || delegating_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Delegating (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
            ...
            $('.couch_mid').on('input', function () {
                ...
                if (couch_mid < 1 || couch_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Couching and Counseling (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
            ...
            $('.develop_mid').on('input', function () {
                ...
                if (develop_mid < 1 || develop_mid > 5) {
                    $(this).addClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('Developing Subordinate (Mid Year) must be between 1 and 5.');
                } else {
                    $(this).removeClass('is-invalid');
                    $(this).siblings('.invalid-feedback').text('');
                }
       ...
       $('#edit').on('click', function () {
            ...
            $editInputs.each(function () {
                ...
                console.log('Mengganti elemen dengan class: ' + spanClass);
