...
<script src="<?= base_url('/css/plugins/datatables/jquery.dataTables.js') ?>"></script>
<link rel="stylesheet" type="text/css" href="<?= base_url('/css/plugins/datatables/rowReorder.dataTables.min.css') ?>">
<script type="text/javascript" src="<?= base_url('/css/plugins/datatables/dataTables.rowReorder.min.js') ?>"></script>
