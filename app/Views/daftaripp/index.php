                        ...
                        <thead>
                            <tr>
                                ...
                                <?php if (session()->get('kode_jabatan') == 2): ?>
                                    <th class="text-center" style="width: 70px;">Kadept</th>
                                    <th class="text-center" style="width: 70px;">Kadiv</th>
                                    <th class="text-center" style="width: 70px;">Director</th>
                                <?php endif; ?>
                                <!-- Kondisi untuk acc kadept oleh kadiv dan Director serta kadiv oleh Director and presdir -->
                                <?php if (session()->get('kode_jabatan') == 1): ?>
                                    <th class="text-center" style="width: 70px;">Kadiv</th>
                                    <th class="text-center" style="width: 70px;">Director</th>
                                    <th class="text-center" style="width: 70px;">Presdir</th>
                                <?php endif; ?>
                                <!-- Kondisi untuk acc kadiv oleh Director and presdir -->
