                                            ...
                                            <?php else: ?>
                                                ...
                                                <div class="form-group row mt-3">
                                                    ...
                                                    <div class="col-sm-7">
                                                        ...
                                                        <?php
                                                            if($strongweakmain['type_karyawan'] === 'EXPERT'){
                                                                echo '
                                                                ...
                                                                if ($strongweakmain['id_department'] == 29){
                                                                    // MAINTENANCE
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 23){
                                                                    // MARKETING
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="" disable>-- Pilih Technical Competency --</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 22){
                                                                    // FAC & RISK MGT CTRL
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="" disable>-- Pilih Technical Competency --</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 24){
                                                                    // MIS
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="" disable>-- Pilih Technical Competency --</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 20 && session()->get('department') === 'HRD'){
                                                                    // HRD
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 20){
                                                                    // GA & IR
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                        <option value="Industrial relation & termination">Industrial relation & termination</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 25){
                                                                    // PROCUREMENT
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="Quality Management">Quality Management</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 30){
                                                                    // EHS
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                    ...
                                                                    ';
                                                                } elseif(in_array($strongweakmain['id_department'], [31, 32])){
                                                                    // PRODUCTION 1 & 2
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="" disable>-- Pilih Technical Competency --</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 33){
                                                                    // PPIC
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="" disable>-- Pilih Technical Competency --</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 28){
                                                                    // PRODUCT ENGINEERING
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="Quality management">Quality management</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 26){
                                                                    // PROCESS ENGINEERING
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="Manufacturing process design">Manufacturing process design</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 27){
                                                                    // ISD
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="" disable>-- Pilih Technical Competency --</option>
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 34){
                                                                    // SPV S2 & S3
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="technical_mid" id="technical_mid">
                                                                            <option value="Production system">Production system</option>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <div class="form-group row mt-3">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <?php
                                                            if ($strongweakmain['type_karyawan'] === 'EXPERT'){
                                                                echo '<select class="form-control mt-2 mb-2" name="weak_technical_mid" id="weak_technical_mid">
                                                                    <option value="" disable>-- Pilih Technical Competency --</option>
                                                                    <option value="Technical Drawing">Technical Drawing</option>
                                                                    <option value="Part/Component Design">Part/Component Design</option>
                                                                    <option value="Material Knowledge">Material Knowledge</option>
                                                                ...
                                                                if ($strongweakmain['id_department'] == 29){
                                                                    ...
                                                                    ';
                                                                } elseif($strongweakmain['id_department'] == 21){
                                                                    // PROCUREMENT
                                                                    echo '
                                                                        <select class="form-control mt-2 mb-2" name="weak_technical_mid" id="weak_technical_mid">
                                                                            <option value="Negotiation skill">Negotiation skill</option>
