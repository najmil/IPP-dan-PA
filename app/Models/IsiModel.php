...
class IsiModel extends Model{
    ...
    public function getIsi($id_main = null) {
        if ($id_main === null) {
            ...
            $result = $this->select('isi_ipp.*, main.id AS id_main, main.created_by AS field1, main.nama AS field2, main.approval_kasie, main.approval_kadept, main.approval_kadiv, main.approval_bod, main.approval_presdir')
